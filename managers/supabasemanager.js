const SupabaseManager = {
  ...
  updateAuthUI() {
    ...
    const mobileWelcomeTitle = document.querySelector('.mobile-welcome h2');
    ...
    if (this.isOnline && this.currentUser) {
        ...
        // Update dropdown (keep as "Hello")
        userEmail.textContent = `Hello, ${displayName}`;
        
        // Update main header welcome message
        if (mainWelcomeTitle) {
            mainWelcomeTitle.textContent = `Welcome, ${displayName}`;
        }
        
        // Update mobile welcome message
        if (mobileWelcomeTitle) {
            mobileWelcomeTitle.textContent = `Welcome, ${displayName}`;
        }
        ...
        if (mainWelcomeTitle) {
            mainWelcomeTitle.textContent = 'Welcome, Trader';
        }
        if (mobileWelcomeTitle) {
            mobileWelcomeTitle.textContent = 'Welcome, Trader';
        }
    }
},  
    async signIn() {
