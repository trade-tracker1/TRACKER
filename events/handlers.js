...
const tradeData = {
  ...
  const trade = {
    ...
    handleEditTradeFromDetails() {
        const tradeId = document.getElementById('edit-trade-btn').getAttribute('data-trade-id');
        Modals.closeTradeDetailsModal();
        Modals.openEditTradeModal(tradeId);
    },

    handleDeleteTradeFromDetails() {
        const tradeId = document.getElementById('delete-trade-btn').getAttribute('data-trade-id');
